// CameraCalibration.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(int argc, char*argv[])
{
	...
	vector<Point3f> pts3D;		//spatial and image coordinates of the object
